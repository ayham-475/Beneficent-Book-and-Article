      ...
      <div className={`max-w-6xl mx-auto pt-16 px-4 ${isFullscreen ? 'w-full' : ''}`} dir="rtl">
        ...
        <div style={neumorphicCardStyle} className="p-8 md:p-12 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
            ...
            <div className="space-y-4">
              <label className="text-sm font-black text-gray-500 mr-2">تاريخ النشر *</label>
              <input 
                style={neumorphicInputStyle}
                value={articleData.publishedDate} 
                onChange={(e) => setArticleData({...articleData, publishedDate: e.target.value})}
                type="date" 
              />
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4 w-full md:w-auto">
            ...
            <button className="flex-1 md:flex-none px-10 py-4 bg-[#319795] text-white rounded-2xl font-bold shadow-lg shadow-[#319795]/30 hover:shadow-[#319795]/50 transition-all active:scale-95">
              نشر الآن
            </button>
          </div>
        </div>
