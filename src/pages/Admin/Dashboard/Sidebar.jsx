            ...
            return (
              <Link to={item.path} key={item.id} className="block">
                <button
                  ...
                  className={`w-full h-14 flex items-center rounded-2xl transition-all duration-300 relative group/btn ${
                    isActive 
                ...
                >
                  ...
                  <motion.span 
                    className={`font-black text-sm whitespace-nowrap z-10 pr-2 transition-all duration-300 ${
