...
const BookDetails = () => {
 ...
 <> <Hedder/>
    <div className="min-h-screen  bg-[#050816] text-white font-sans p-4 md:p-12" dir="rtl">
      ...
      <div className="max-w-6xl m -auto bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-[3rem] overflow-hidden shadow-2xl relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          <div className="relative p-12 flex items-center justify-center  bg-gradient-to-br from-blue-600/5 to-transparent">
            ...
            >
              <img 
                src={bookDetails[indexBookDetails].img}
